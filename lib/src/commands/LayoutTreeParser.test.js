...
describe('LayoutTreeParser', () => {
  ...
  describe('createContainer', () => {
    ...
    it('creates native container object', () => {
      const json = { name: 'Name', isNative: true };
      const container = uut.parseFromSimpleJSON(json);

      expect(container).toEqual({ type: 'Native', data: json, children: [] });
    });
  });
